<template>
  <div class="erp-page-container">
    ...
    <!-- ─── 1. MODERN STICKY HEADER (CRM STYLE) ─── -->
    <header class="order-header-modern">
      <div class="header-main-row">
        <!-- Left: Back & Title/Number -->
        ...
        <!-- Center: Settings Fields integrated into Header -->
      ...
      <!-- Optional Supplier Info Strip (shown when supplier selected) -->
      <transition name="slide-fade">
        <div class="supplier-info-strip" v-if="selectedSupplierObj">
          ...
          <div class="info-item status-pill-mini" :class="paymentStatusClass">{{ paymentStatusLabel }}</div>
        </div>
      </transition>
    </header>
...
.modern-select { width: 180px; }
.modern-date-picker { width: 110px; }
...
.rating-dot.reliable { background: #10B981; box-shadow: 0 0 6px rgba(16, 185, 129, 0.4); }
.rating-dot.new { background: #F59E0B; box-shadow: 0 0 6px rgba(245, 158, 11, 0.4); }
...
.info-item .el-icon { color: #94A3B8; }
